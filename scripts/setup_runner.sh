...
./config.sh --url https://github.com/pranavtondgaonkar/ML-SCANIA-APS-FAILURE-PREDICTION.git --token $1 --runnergroup Default --name self-hosted --labels scania_aps --work _work --replace [--name self-hosted] 
